...
swords = {"Silver Sword": 15, "Brave Sword": 8, "Slaying Edge": 14, "Wo Dao": 13, "Armorsmasher": 14, "Zanbato": 14, "Ruby Sword": 12, "Firesweep Sword": 15, "Safeguard": 14, "Barrier Blade": 14, "Kadomatsu": 14, "Geishun": 14, "Heart's Blade": 14}
#Firesweep Axe
axes = {"Silver Axe": 15, "Brave Axe": 8, "Slaying Axe": 14, "Wo Gùn": 14, "Slaying Hammer": 14, "Poleaxe": 14, "Emerald Axe": 12, "Legion's Axe": 14, "Carrot Axe": 13, "Melon Crusher": 14, "Lilith Floatie": 14, "Sack o' Gifts": 14, "Handbell": 14, "Hagoita": 14, "Giant Spoon": 13, "Ardent Service": 14, "Beach Banner": 14, "Hack-o'Lantern": 14, "Faithful Axe": 14}
lances = {"Silver Lance": 15, "Brave Lance": 8, "Slaying Lance": 14, "Harmonic Lance": 13, "Slaying Spear": 14, "Ridersbane": 14, "Sapphire Lance": 12, "Firesweep Lance": 15, "Reprisal Lance": 14, "Vanguard": 14, "Berkut's Lance": 14, "Carrot Lance": 13, "First Bite": 14, "Deft Harpoon": 14, "Tannenboom!": 14, "Casa Blanca": 14, "Shell Lance": 14, "Wagasa": 14}
bows = {"Silver Bow": 13, "Brave Bow": 7, "Slaying Bow": 12, "Short Bow": 12, "Assassin's Bow": 11, "Guard Bow": 12, "Firesweep Bow": 11, "Shining Bow": 12, "Clarisse's Bow": 11, "Cupid Arrow": 11, "Refreshing Bolt": 12, "Monstrous Bow": 12, "Hama Ya": 12, "Gratia": 12, "Cocobow": 12, "Fishie Bow": 12, "Devilish Bow": 12, "Kabura Ya": 12}
daggers = {"Silver Dagger": 10, "Smoke Dagger": 9, "Poison Dagger": 5, "Rogue Dagger": 7, "Barb Shuriken": 12, "The Cleaner": 12, "Seashell": 10, "Dancer's Fan": 10, "Kitty Paddle": 8, "Kagami Mochi": 12, "Lethal Carrot": 12, "Starfish": 12, "Sky Maiougi": 12, "Cloud Maiougi": 12, "Dusk Uchiwa": 12, "Bottled Juice": 12, "Goodie Boot": 12, "Red Hot Ducks": 12, "Splashy Bucket": 12, "Ouch Pouch": 12}
fires = {"Bolganone": 13}
winds = {"Rexcalibur": 13, "Gronnblade": 13, "Keen Gronnwolf": 12, "Gronnraven": 11, "Gronnowl": 10, "Gronnserpent": 12, "Green Egg": 11, "Hibiscus Tome": 12, "Dancer's Ring": 12, "Spectral Tome": 12, "Green Gift": 12, "Gronnblooms": 12}
thunders = {"Thoron": 13}
...
#beasts = {"Adult": 9} (Flier), (Infantry), (Cavalry)

reds = {"Rauðrblade": 13, "Keen Rauðrwolf": 12, "Rauðrraven": 11, "Rauðrowl": 10, "Tomato Tome": 12, "Candelabra": 12, "Loyal Wreath": 12}
#Rauðrserpent, Rauðrblooms
blues = {"Blárblade": 13, "Keen Blárwolf": 12, "Blárraven": 11, "Blárowl": 10, "Blárserpent": 12, "Blue Egg": 11, "Blessed Bouquet": 12, "Sealife Tome": 12, "Dancer's Score": 12, "Blue Gift": 12, "Fresh Bouquet": 12, "Juicy Wave": 12, "Blárblooms": 12}
...
exclusiveAxes = {"Armads": 16, "Basilikos": 16, "Hauteclere": 16, "Nóatún": 16, "Sinmara": 16, "Stout Tomahawk": 16, "Urvan": 16, "Urðr": 16, "Berserk Armads": 16, "Camilla's Axe": 16, "Býleistr": 16, "Thunder Armads": 16, "Draconic Poleax": 16, "Wolf Berg": 16, "Garm": 16, "Cherche's Axe": 11, "Axe of Virility": 16, "Hel Scythe": 16, "Grado Poleax": 16, "Glitnir": 16}
exclusiveLances = {"Fensalir": 16, "Leiptr": 16, "Siegmund": 16, "Gradivus": 16, "Cursed Lance": 16, "Geirskögul": 16, "Vidofnir": 16, "Bright Naginata": 16, "Hinoka's Spear": 16, "Flame Siegmund": 16, "Rhomphaia": 16, "Dauntless Lance": 16, "Maltet": 16, "Gáe Bolg": 16, "Shanna's Lance": 16, "Florina's Lance": 16, "Whitewing Lance": 16, "Whitewing Spear": 16, "Festive Siegmund": 16, "Oboro's Spear": 16}
exclusiveBows = {"Fujin Yumi": 14, "Mulagir": 14, "Nidhogg": 14, "Parthia": 14, "Skadi": 14, "Warrior Princess": 14, "Swift Mulagir": 14, "Thögn": 14, "Niles's Bow": 14, "Argent Bow": 8}
...
exclusiveWinds = {"Élivágar": 14, "Excalibur": 14, "Naga": 14, "Divine Naga": 14, "Dark Excalibur": 14, "Blizzard": 14, "Wind's Brand": 14, "Munnin's Egg": 14, "Thunderhead": 14, "Nifl Frostflowers": 14, "Giga Excalibur": 14, "Forseti": 14, "Book of Shadows": 14, "Tactical Gale": 14, "Ífingr": 14, "Iris's Tome": 14}
...
exclusiveBreaths = {"Great Flame": 16, "Expiration": 16, "Breath of Fog": 16, "Summer Breath": 16, "Breath of Blight": 16, "Divine Mist": 16, "Spirit Breath": 16, "Draconic Rage": 16, "Fell Breath": 16, "Demonic Breath": 16}
exclusiveBeasts = {"Hawk King Claw": 14, "Heron Wing": 14, "Raven King Beak": 14, "Wolf Queen Fang": 14, "Wolfskin Fang": 9, "Kitsune Fang": 14, "Wolfpup Fang": 14, "Foxkit Fang": 14, "Taguel Fang": 14}
...
assists = ["Swap", "Shove", "Smite", "Draw Back", "Reposition", "Pivot", "Ardent Sacrifice", "Harsh Command", "Reciprocal Aid", "Rally Attack/Speed", "Rally Attack/Defense", "Rally Attack/Resistance", "Rally Speed/Defense", "Rally Speed/Resistance", "Rally Defense/Resistance", "Rally Up Attack", "Rally Up Resistance"]
#Rally Atk/Spd, Spd/Def, and Res/Def are the + versions
...
normalBs = ["Vantage", "Quick Riposte", "Desperation", "Brash Assault", "Daggerbreaker", "Wings of Mercy", "Escape Route", "Renewal", "Guard", "Obstruct", "Chill Attack", "Chill Speed", "Chill Defense", "Chill Resistance", "Dull Ranged", "Sabotage Attack"]
#Sabotage Speed, Defense, Resistance
meleeBs = ["Drag Back", "Hit and Run", "Knock Back", "Lunge", "Dull Close"]
staffBs = ["Live to Serve", "Dazzling Staff", "Wrathful Staff"]
noStaffBs = ["Seal Attack", "Seal Speed", "Seal Defense", "Seal Resistance", "Seal Attack/Speed", "Seal Attack/Defense", "Seal Speed/Defense", "Seal Defense/Resistance", "Poison Strike", "Watersweep", "Windsweep", "Attack Feint", "Speed Feint", "Defense Feint", "Resistance Feint", "Attack/Speed Link", "Attack/Defense Link", "Attack/Resistance Link", "Speed/Resistance Link", "Defense/Resistance Link", "Mystic Boost"]
#Seal Atk/Res, Seal Spd/Res, Spd/Def Link
...
flierCs = ["Hone Fliers", "Fortify Fliers", "Goad Fliers", "Ward Fliers", "Guidance", "Flier Guidance", "Air Orders"]
dragonCs = ["Hone Dragons", "Fortify Dragons", "Goad Dragons", "Ward Dragons", "Dragon Valor"]
#Dragon Experience
beastCs = ["Hone Beast", "Fortify Beasts", "Goad Beasts", "Ward Beasts", "Beast Valor"]
#Beast Experience
...
class Hero:
    ...
    def effectiveness(self):
        ...
        elif (self.weapon.startswith("Keen") and self.weapon.endswith("wolf")) or self.weapon in {"Zanbato", "Poleaxe", "Ridersbane", "Dusk Uchiwa", "Taguel Fang"}:
            self.effective.add("Calvary")
        elif self.weapon in {"Armorsmasher", "Slaying Hammer", "Slaying Spear", "Dauntless Lance", "Sky Maiougi", "Florina's Lance", "Axe of Virility", "Whitewing Spear", "Oboro's Spear", "Demonic Breath"}:
            self.effective.add("Armored")
        elif self.weapon in {"Falchion", "Naga", "Divine Naga", "Sealed Falchion", "Breath of Fog", "Summer Breath", "Cloud Maiougi", "Exalted Falchion", "Divine Mist", "Ífingr", "Splashy Bucket", "Dragonbind"}:
    ...
    def statBonuses(self):
        ...
        if self.weapon in {"Brave Sword", "Brave Axe", "Brave Lance", "Brave Bow", "Dire Thunder", "Meisterschwert", "Cherche's Axe", "Wolfskin Fang"}:
            ...
            self.statAdd[Spd] -= 2
        elif self.weapon in {"Blazing Durandal", "Great Flame", "Laevatein", "Resolute Blade", "Flame Siegmund", "Nifl Frostflowers", "Dawn Suzu", "Garm", "Storm Sieglinde", "Book of Dreams", "Gjöll", "Hawk King Claw", "Fell Breath", "Glitnir"}:
            self.statAdd[Atk] += 3
        elif self.weapon in {"Arya's Blade", "Mulagir", "Weirding Tome", "Skadi", "Níu", "Warrior Princess", "Múspell Fireposy", "Giga Excalibur", "Fruit of Iðunn", "Thögn", "Royal Sword", "Exalted Falchion", "Forseti", "Book of Shadows", "Sylgr", "Hikami", "Prayer Wheel", "Heron Wing", "Raven King Beak", "Wolfpup Fang"}:
            self.statAdd[Spd] += 3
        elif self.weapon in {"Geirskögul", "Ivaldi", "Sinmara", "Beloved Zofia", "Thunder Armads", "Summer Breath", "Wolf Berg", "Spirit Breath", "Sagittae", "Kitsune Fang", "Demonic Breath"}:
            self.statAdd[Def] += 3
        elif self.weapon in {"Blizzard", "Divine Tyrfing", "Gleipnir", "Thani", "Grima's Truth", "Swift Mulagir", "Loptous", "Aversa's Night", "Imhullu", "Lyfjaberg", "Foxkit Fang"}:
            self.statAdd[Res] += 3
    ...
    def Cooldown(self):
        ...
        if self.weapon in {"Rauðrblade", "Gronnblade", "Blárblade", "Lightning Breath"}:
            self.cooldown += 1
        elif self.weapon in {"Slaying Edge", "Slaying Axe", "Slaying Lance", "Slaying Bow", "Hauteclere", "Mystletainn", "Cursed Lance", "Urvan", "Audhulma", "Basilikos", "Kagami Mochi", "Berserk Armads", "Nameless Blade", "Barb Shuriken", "Dark Mystletainn", "Mjölnir", "Vassal's Blade", "Dauntless Lance", "Maltet", "Hoarfrost Knife", "Missiletainn", "Solitary Blade", "Shanna's Lance", "Golden Dagger", "Draconic Rage", "Scarlet Sword", "Whitewing Lance", "Festive Siegmund", "Hel Scythe", "Wolf Queen Fang", "Grado Poleax", "Niles's Bow"}:
            self.cooldown -= 1
