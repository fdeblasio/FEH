...
fires = {"Bolganone": 13}
winds = {"Rexcalibur": 13, "Gronnblade": 13, "Keen Gronnwolf": 12, "Gronnraven": 11, "Gronnowl": 10, "Green Egg": 11, "Hibiscus Tome": 12, "Dancer's Ring": 12, "Spectral Tome": 12, "Green Gift": 12, "Gronnblooms": 12}
#Gronnserpent
thunders = {"Thoron": 13}
...
exclusiveAxes = {"Armads": 16, "Basilikos": 16, "Hauteclere": 16, "Nóatún": 16, "Sinmara": 16, "Stout Tomahawk": 16, "Urvan": 16, "Urðr": 16, "Berserk Armads": 16, "Camilla's Axe": 16, "Býleistr": 16, "Thunder Armads": 16, "Draconic Poleax": 16, "Wolf Berg": 16, "Garm": 16, "Cherche's Axe": 11, "Axe of Virility": 16, "Hel Scythe": 16, "Grado Poleax": 16}
...
exclusiveBows = {"Fujin Yumi": 14, "Mulagir": 14, "Nidhogg": 14, "Parthia": 14, "Skadi": 14, "Warrior Princess": 14, "Swift Mulagir": 14, "Thögn": 14, "Niles's Bow": 14}
...
exclusiveDarks = {"Brynhildr": 14, "Gleipnir": 14, "Naglfar": 14, "Grimoire": 14, "Grima's Truth": 14, "Loptous": 14, "Aversa's Night": 14, "Book of Dreams": 14, "Imhullu": 14, "Tharja's Hex": 14}
exclusiveLights = {"Aura": 14, "Thani": 14, "Ivaldi": 14, "Wargod's Tome": 14, "Sagittae": 14, "Prayer Wheel": 14}
exclusiveBreaths = {"Great Flame": 16, "Expiration": 16, "Breath of Fog": 16, "Summer Breath": 16, "Breath of Blight": 16, "Divine Mist": 16, "Spirit Breath": 16, "Draconic Rage": 16, "Fell Breath": 16}
...
assists = ["Swap", "Shove", "Smite", "Draw Back", "Reposition", "Pivot", "Ardent Sacrifice", "Harsh Command", "Reciprocal Aid", "Rally Up Attack", "Rally Attack/Speed", "Rally Attack/Defense", "Rally Attack/Resistance", "Rally Speed/Defense", "Rally Speed/Resistance", "Rally Defense/Resistance"]
...
noStaffBs = ["Seal Attack", "Seal Speed", "Seal Defense", "Seal Resistance", "Seal Attack/Speed", "Seal Attack/Defense", "Seal Defense/Resistance", "Poison Strike", "Watersweep", "Windsweep", "Attack Feint", "Speed Feint", "Defense Feint", "Resistance Feint", "Attack/Speed Link", "Attack/Defense Link", "Attack/Resistance Link", "Speed/Resistance Link", "Defense/Resistance Link", "Mystic Boost"]
#Seal Atk/Res, Seal Spd/Def, Seal Spd/Res, Spd/Def Link
...
staffCs = ["Staff Valor"]
#Staff Experience
exclusiveCs = ["Ostia's Pulse", "With Everyone!", "Surtr's Menace", "Sparkling Boost", "Glare", "Upheaval"]
...
class Hero:
    ...
    def effectiveness(self):
        ...
        elif self.weapon in {"Armorsmasher", "Slaying Hammer", "Slaying Spear", "Dauntless Lance", "Sky Maiougi", "Florina's Lance", "Axe of Virility", "Whitewing Spear", "Oboro's Spear"}:
            self.effective.add("Armored")
        elif self.weapon in {"Falchion", "Naga", "Divine Naga", "Sealed Falchion", "Breath of Fog", "Summer Breath", "Cloud Maiougi", "Exalted Falchion", "Divine Mist", "Ífingr", "Splashy Bucket"}:
    ...
    def statBonuses(self):
        ...
        if self.weapon in {"Brave Sword", "Brave Axe", "Brave Lance", "Brave Bow", "Dire Thunder", "Meisterschwert", "Cherche's Axe"}:
            ...
            self.statAdd[Spd] -= 2
        elif self.weapon in {"Blazing Durandal", "Great Flame", "Laevatein", "Resolute Blade", "Flame Siegmund", "Nifl Frostflowers", "Dawn Suzu", "Garm", "Storm Sieglinde", "Book of Dreams", "Gjöll", "Hawk King Claw", "Fell Breath"}:
            self.statAdd[Atk] += 3
