...
exclusiveDaggers = {"Deathly Dagger": 11, "Peshkatz": 14, "Felicia's Plate": 14, "Hoarfrost Knife": 14, "Sylgr": 14}
...
staffCs = ["Staff Valor"]
#Staff Experience
exclusiveCs = ["Ostia's Pulse", "With Everyone!", "Surtr's Menace"]
...
class Hero:
    ...
    def statBonuses(self):
        ...
        if self.weapon in {"Brave Sword", "Brave Axe", "Brave Lance", "Brave Bow", "Dire Thunder", "Meisterschwert", "Cherche's Axe"}:
            ...
            self.statAdd[Atk] += 3
        elif self.weapon in {"Arya's Blade", "Mulagir", "Weirding Tome", "Skadi", "Níu", "Warrior Princess", "Múspell Fireposy", "Giga Excalibur", "Fruit of Iðunn", "Thögn", "Royal Sword", "Exalted Falchion", "Forseti", "Book of Shadows", "Sylgr"}:
            self.statAdd[Spd] += 3
            ...
            self.statAdd[Def] += 3
        elif self.weapon in {"Blizzard", "Divine Tyrfing", "Gleipnir", "Thani", "Grima's Truth", "Swift Mulagir", "Loptous", "Aversa's Night", "Imhullu"}:
            self.statAdd[Res] += 3
